...
|---|---|---|---|---:|---:|---|---:|---:|---:|---|
| Clean baseline | reference | none | none | 0 | 0.9173 | 7_to_1_confusion | 0.0117 |  |  | Full MNIST train/test split with multinomial SGD logistic classifier. |
| Random label flip | poisoning | M | R3 | 10.00% | 0.8914 | clean_accuracy_drop | 0.0259 |  |  | 6000 labels changed. |
| Targeted label flip | poisoning | M | R2 | 35% of digit 7 | 0.9074 | 7_to_1_confusion | 0.0525 |  |  | 2193 source labels changed. |
| Subpopulation label poison | poisoning | M | R2 | 80% of selected subgroup | 0.8972 | subpopulation_to_target_confusion | 0.4434 |  |  | 1504 source-subgroup labels changed. |
| BadNets patch backdoor | poisoning | B | R1 | 5.00% appended | 0.9115 | trigger_ASR_to_1 | 0.9988 |  |  | 3000 triggered non-target copies. |
| Clean-label patch backdoor | poisoning | B | R1 | 5.00% target-class copies | 0.9157 | trigger_ASR_to_1 | 0.3717 |  |  | 3000 correctly labeled target images patched. |
