...
| Implementation-upgrade | MNIST CNN baseline | reference | scripts/mnist_attack_comparison.py::MNISTCnn | Clean baseline | implemented |
| Implementation-upgrade | Activation clustering defense | defense | scripts/mnist_attack_comparison.py::activation_cluster_filter | --defense activation_clustering | implemented |
| Implementation-upgrade | PGD epsilon sweep | evaluation | scripts/fungi_attack_comparison.py::run_pgd_epsilon_sweep; scripts/mnist_attack_comparison.py::run_epsilon_sweep | *_attack_sweep.* | implemented |
