...
|---|---|---|---|---|---|
| Poster-required | FGSM | evasion | scripts/fungi_attack_comparison.py::fgsm | FGSM | implemented |
| Poster-required | PGD | evasion | scripts/fungi_attack_comparison.py::pgd | PGD | implemented |
